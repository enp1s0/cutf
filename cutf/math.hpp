...
__half add(__half2 a) {return a.x + a.y;}
__half mul(__half2 a) {return a.x * a.y;}
__half max(__half2 a) {return cutf::math::max(a.x, a.y);}
__half min(__half2 a) {return cutf::math::min(a.x, a.y);}
} // namespace horizontal
} // math
} // cutf

...
__device__ __host__ inline float cut_mantissa(const float v) {
	...
	const uint32_t c0 = (in & (1u << (mantissa_length - 1)));
	const uint32_t m = (in & (0b0'00000000'1111111111'1111111111111u - ((1u << mantissa_length) - 1)));
	...
	const uint32_t m_pre = m0 & (0b0'00000000'1111111111'1111111111111u - ((1u << mantissa_length) - 1));
